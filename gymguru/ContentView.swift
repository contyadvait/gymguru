...
struct ContentView: View {
    @State var challengesAvailable = [ChallengeData(challengeName: "Stroll Stride", challengeDescription: "Go for a leisure walk for a few kilometers. You can walk around greenery, or walk around your city.", challengeItems: [ExerciseItem(workoutItem: .walk, workoutTrackType: .map, amount: 5)], badges: []),
                                      ...
                                      ChallengeData(challengeName: "Jump&Joy", challengeDescription: "Jump for joy as you jumprope!", challengeItems: [ExerciseItem(workoutItem: .jumpRope, workoutTrackType: .counter, amount: 25)], badges: [Badge(badge: "Jump for Joy", sfIcon: "figure.jumprope", obtainingExercise: .jumpRope, amountOfObtainingExercise: 25, obtained: false)]),
